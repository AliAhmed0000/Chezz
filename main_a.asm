...
white_or_blak_piece macro piecee_type;piece_color = 'w' or 'b' or '0'
  local end_white_or_blak_piece,not_whitee,not_zeroo
    cmp piecee_type,'a'
    jb not_whitee
...
.data
    ...
    b_won_mes db "BLACK WON!!",'$'
    w_won_mes db "WHITE WON!!",'$'
    return_mes db "PRESS",'$'
    ret_mes2 db "Any key",'$'
    ;--------------part1-------------------------;
    ...
    ;-----killed messages--------------
        b_killed db 0
        w_killed db 0
        b_pieces_mes db 'b pieces gone','$'
        w_pieces_mes db 'w pieces gone','$'
        b_sold_kill_mes  db '*b sold killed**','$'
        b_tab_kill_mes   db '*b tab killed**','$'
        b_fel_kill_mes   db '*b fel killed**','$'
        b_king_kill_mes  db '*b king killed**','$'
        b_wazer_kill_mes db '*b wazer killed**','$'
        b_horse_kill_mes db '*b horse killed**','$'

        sold_kill_mes  db '*w sold killed**','$'
        tab_kill_mes   db '*w tab killed**','$'
        fel_kill_mes   db '*w fel killed**','$'
        king_kill_mes  db '*w king killed**','$'
...
mov ah,0 ;wait for any key to get pressed
int 16h
...
ckeck_wineer proc
    cmp winner,0
    jne jump_out_continue_loop
    jmp end_ckeck
    jump_out_continue_loop:
    mov continue_counter,0
...
;     squares_container db "t h f w k f h t"
;  db 8 dup('s')
;  db 8 dup('0')
;  db 8 dup('0')
;  db 8 dup('0')
...
;  db 8 dup('S')
;  db "T H F W K F H T"
    mov squares_container,"t"
    mov squares_container+1,"h"
    mov squares_container+2,"f"
    mov squares_container+3,"w"
    mov squares_container+4,"k"
    mov squares_container+5,"f"
    mov squares_container+6,"h"
    mov squares_container+7,"t"
    mov squares_container+8,"s"
    mov squares_container+9,"s"
    mov squares_container+10,"s"
    mov squares_container+11,"s"
    mov squares_container+12,"s"
    mov squares_container+13,"s"
    mov squares_container+14,"s"
    mov squares_container+15,"s"
    mov squares_container+16,"0"
    mov squares_container+17,"0"
    mov squares_container+18,"0"
    mov squares_container+19,"0"
    mov squares_container+20,"0"
    mov squares_container+21,"0"
    mov squares_container+22,"0"
    mov squares_container+23,"0"
    mov squares_container+24,"0"
    mov squares_container+25,"0"
    mov squares_container+26,"0"
    mov squares_container+27,"0"
    mov squares_container+28,"0"
    mov squares_container+29,"0"
    mov squares_container+30,"0"
    mov squares_container+32,"0"
    mov squares_container+33,"0"
    mov squares_container+34,"0"
    mov squares_container+35,"0"
    mov squares_container+36,"0"
    mov squares_container+37,"0"
    mov squares_container+38,"0"
    mov squares_container+39,"0"
    mov squares_container+40,"0"
    mov squares_container+41,"0"
    mov squares_container+42,"0"
    mov squares_container+43,"0"
    mov squares_container+44,"0"
    mov squares_container+45,"0"
    mov squares_container+46,"0"
    mov squares_container+47,"0"
    mov squares_container+48,"S"
    mov squares_container+49,"S"
    mov squares_container+50,"S"
    mov squares_container+51,"S"
    mov squares_container+52,"S"
    mov squares_container+53,"S"
    mov squares_container+54,"S"
    mov squares_container+55,"S"
    mov squares_container+56,"T"
    mov squares_container+57,"H"
    mov squares_container+58,"F"
    mov squares_container+59,"W"
    mov squares_container+60,"K"
    mov squares_container+61,"F"
    mov squares_container+62,"H"
    mov squares_container+63,"T"
    ;mov squares_container+64,"h"
...
wazerr_b proc
    ...
    l122:
        ...
        jmp exit122
        wazerr_cont02:
        get_0to64_from_xy x_new2,y_new2 ;bl=0to64
        white_or_blak_piece squares_container[bx]
        cmp piece_color,'b'
        je exit122
                  set_place_available x_new2,y_new2
          draw_rectangle x_new2,y_new2,color_avilable_moves2;color_avilable_moves2 is the highlight color
...
tabiaa_b proc
    ...
    l1666:
        ...
        je exit1666
                set_place_available x_new2,y_new2
          draw_rectangle x_new2,y_new2,color_avilable_moves2;color_avilable_moves is the highlight color
...
exit255:
    ...
    mov y_new2,ah
        ...
        cmp x_new2,-1
        jne h712
        jmp exit2color_avilable_moves22
        h712:
        dec x_new2
        dec y_new2
        cmp x_new2,-1
        ...
        white_or_blak_piece squares_container[bx]
        cmp piece_color,'b'
        je exit2color_avilable_moves22
          set_place_available x_new2,y_new2
          draw_rectangle x_new2,y_new2,color_avilable_moves2;color_avilable_moves2 is the highlight color
exit2color_avilable_moves22:
